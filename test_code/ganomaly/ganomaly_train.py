...
def main():
    print("🚀 GANomaly トレーニング（最終安定版 v3.2）")
    print("=" * 60)
    ...
    root = dataset_map.get(DATASET_CHOICE, "../../datasets/rp")
    output_root = f"results/ganomaly_{DATASET_CHOICE}_v3"

    check_dataset(root)

    # Transform（Anomalibのデフォルトに任せる）
    datamodule = Folder(
        name=f"GANomaly_{DATASET_CHOICE}_v3",
        root=root,
